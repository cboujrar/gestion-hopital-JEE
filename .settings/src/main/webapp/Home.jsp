...
<body>
  ...
  <div class="container navigation" style="background: -webkit-linear-gradient(left, #3931af, #00c6ff);width: 98.85vw;height: 70px;padding-top: 10px;">
          ...
          <a class="navbar-brand js-scroll-trigger" href=# style="margin-top: 0px;font-family: 'IBM Plex Sans', sans-serif;"><h5 style="color: white;">&nbsp GLOBAL HOSPITALS</h5></a>
        ...
        <div class="collapse navbar-collapse navbar-right navbar-main-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="Logine.jsp" style="margin-right: 40px;font-family: 'IBM Plex Sans', sans-serif;color: white">LOGIN</a></li>
